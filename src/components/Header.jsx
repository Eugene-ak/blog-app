...
const Header = () => {
  ...
  // Function is toggle dark mode or light mode
  //   function handleClick() {
  //     setIsClicked(true);
  //   }

  // function to show nav menu in mobile view
  function showMenu() {
      ...
      <nav className="nav">
        ...
        <div className="nav-list-container">
          <ul>
            ...
            <li>
              <NavLink to="SinglePostsPage/">Single Post</NavLink>
            </li>
            <li>
        ...
        <div className="mobile-menu" ref={navRef}>
          <div>
            <ul>
              ...
              <li>
                <Link to="SinglePostsPage/" onClick={showMenu}>Single Post</Link>
              </li>
              <li>
                <Link to="ContactPage/" onClick={showMenu}>Contact</Link>
              </li>
            </ul>
          </div>
          <div>
